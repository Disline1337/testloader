...
constexpr auto GUARDP = "/";
constexpr auto HOST = ("f0632720.xsph.ru");
constexpr auto HOST2 = ("f0632720.xsph.ru");
...
{
	VM_DOLPHIN_BLACK_START
	string SerialKey = GetSerial();
	string Serial = GetSerial64();

	string UrlRequest = GUARDP;
	...
	system("cls");
	cout << "sent this admin: " << SerialKey << endl;
	MessageBox(hWnd, "OK - sent hwid to admin", "Hwid error", MB_OKCANCEL);
	Sleep(5000);
	exit(1);
