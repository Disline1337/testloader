...
namespace dchar_impl {

#ifdef _MSC_VER
#define DCHAR_INLINE __forceinline
#else
#define DCHAR_INLINE inline
#endif
    ...
    public:
        template <size_t... Is>
        constexpr DCHAR_INLINE string(const char* str, std::index_sequence<Is...>) :
            key_(random_char<K>::value), encrypted_{ { enc(str[Is])... } } {}

        DCHAR_INLINE decltype(auto) decrypt() {
...
#define dchar(s) (dchar_impl::string<sizeof(s) - 1, \
